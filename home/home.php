...
<body>
    ...
    <div>
      <div>
        <h1 class="animate__animated animate__fadeInUp">
          <span>WELCOME TO OFFICIAL WEBSITE OF</span> <br />
        ...
        <div class="animate__animated animate__backInDown">
          <img class="struktur" src="../asset/feed dpm.png" alt="img">
        </div>
        <!-- Struktur Organisasi -->
        ...
        <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="../asset/sosil.JPG" class="w-50" alt="IMG" />
              <div class="carousel-caption">
                <p>SOSIALISASI ANGGARAN DANA</p>
              </div>
            </div>
            <div class="carousel-item">
              <img src="../asset/ldo.jpg" class="d-block w-50" alt="IMG" />
              <div class="carousel-caption">
                <p>LATIHAN DASAR ORGANISASI</p>
              </div>
            </div>
            <div class="carousel-item">
              <img src="../asset/kelegis.jpg" class="d-block w-50" alt="IMG" />
              <div class="carousel-caption">
                <p>KELAS LEGISLATIF</p>
              </div>
            </div>
            <div class="carousel-item">
              <img src="../asset/dister.jpg" class="d-block w-50" alt="IMG" />
              <div class="carousel-caption">
                <p>DISKUSI TERBUKA</p>
              </div>
            </div>
            <div class="carousel-item">
              <img src="../asset/3x4 Brosur Oprec Dewan Perwakilan Mahasiswa 2024.png" class="d-block w-50" alt="IMG" />
              <div class="carousel-caption">
                <p>OPEN RECRUITMENT</p>
              </div>
            </div>
            <div class="carousel-item">
              <img src="../asset/Pemira.JPG" class="d-block w-50" alt="IMG" />
              <div class="carousel-caption">
                <p>PEMILU RAYA</p>
              </div>
            </div>
        ...
        <br />
        <br />
        <h4 class="content">Berikut adalah Program Kerja Kami :</h4>
        <br />
        ...
        <div class="card-group">
          <div class="card animate__animated animate__fadeInRight">
            ...
            <div class="card-body">
              <h5 class="card-title">SOSIALISASI ANGGARAN DANA</h5>
              <p class="card-text">
          ...
          <div class="card animate__animated animate__fadeInRight">
            ...
            <div class="card-body">
              <h5 class="card-title">LATIHAN DASAR ORGANISASI</h5>
              <p class="card-text">
        ...
        <div class="card-group">
          <div class="card animate__animated animate__fadeInDown">
            ...
            <div class="card-body">
              <h5 class="card-title">KELAS LEGISLATIF</h5>
              <p class="card-text">
          ...
          <div class="card animate__animated animate__fadeInDown">
            ...
            <div class="card-body">
              <h5 class="card-title">DIKUSI TERBUKA</h5>
              <p class="card-text">
        ...
        <div class="card-group">
          ...
          <div class="card animate__animated animate__fadeInLeft">
            ...
            <div class="card-body">
              <h5 class="card-title">PEMILU RAYA</h5>
              <p class="card-text">
                ...
                selanjutnya VOTING, PELANTIKAN, dan selanjutnya DOKUMENTASI.
              </p>
            </div>
          </div>
        </div>
  ...
  <footer class="footer">
    <div class="container">
      <center>
        <p>
          <i class="fa-solid fa-laptop-code" aria-hidden="true"></i> &copy;2024/8 copyright<br>Design &amp;
          Development by <button><a class="port" href="https://dwijatmiko77.github.io/my.portfolio/">Miko</a></button>
        </p>
      </center>
      <div class="row">
        <h4>Contact Me</h4>
        ...
        <div class="social-links-me">
          <a href="https://www.instagram.com/ya_hiiko/"><i class="fa-brands fa-instagram" aria-hidden="true"></i></a>
          <a href="https://web.facebook.com/dwiek.jadmicko?locale=id_ID"><i class="fa-brands fa-facebook-f"
              aria-hidden="true"></i></a>
          <a href="https://wa.me/+6285155454717"><i class="fa-brands fa-whatsapp" aria-hidden="true"></i></a>
        </div>
      </div>
    </div>
  </footer>
